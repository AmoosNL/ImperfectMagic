...
public class LitParticle extends TextureSheetParticle {

    public final LitParticleOptions op;
    ...
    protected LitParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, LitParticleOptions op, SpriteSet spriteSet) {
        super(world, x, y, z);
        this.op = op;
    ...
    public static LitParticleProvider provider(SpriteSet spriteSet) {
        return new LitParticleProvider(spriteSet);
    }
    ...
    public static class LitParticleProvider implements ParticleProvider<LitParticleOptions> {
        private final SpriteSet spriteSet;

        public LitParticleProvider(SpriteSet spriteSet) {
            this.spriteSet = spriteSet;
        }

        public Particle createParticle(LitParticleOptions typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new LitParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, typeIn, this.spriteSet);
        }
